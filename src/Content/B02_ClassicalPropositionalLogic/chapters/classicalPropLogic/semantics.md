...
is Boolean *false*. For variable expressions, given an
...
other connectives (operators) of propositional logic are defined
...
| BinOp.and => Bool.and
| BinOp.or => Bool.or
| BinOp.imp => domain.imp   -- Content.B02_ClassicalPropositionalLogic.chapters.lecture.propLogic.domain.imp
...
## Evaluation: Operational Semantics of Propositional Logic
...
That's it. From this material you should be able to acquire
