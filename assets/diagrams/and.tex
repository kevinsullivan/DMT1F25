...
\end{tikzpicture}
% --- CAPTION REFINEMENT: Corrected typo ---
...
two proofs $p$ of $P$ and of $q$ of $Q$ and returns a proof, $p, q>$ of their conjunction, The $And.left$
function takes a  proof, $<p, q>$ of $P \land Q$, and returns the proof, $(p : P)$, while $And.right$ returns 
$q : Q$.the proof. All of these proof handling functions implicitly take the types P and Q themselves as 
implicit arguments. They are typically not provided explicitly when these funcitons are applied to their 
